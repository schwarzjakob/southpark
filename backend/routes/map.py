...
def get_coordinates():
    try:
        ...
        parking_lots_data = df_parking_lots.to_dict(orient="records") if not df_parking_lots.empty else []
        ...
        entrances_data = df_entrances.to_dict(orient="records") if not df_entrances.empty else []
